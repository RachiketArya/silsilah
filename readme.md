...
3. Make sure you run this command: ```php artisan storage:link``` before you run the next command. It links the public storage directory to the laravel directory.
4. Run the php server using ```php artisan serve```